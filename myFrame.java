			...
			jb1.addActionListener(new ActionListener() 
			{
				public void actionPerformed(ActionEvent e) 
				{
					try 
					{
						...
						Connection conn =    DriverManager.getConnection("jdbc:mysql://localhost:3306/swi", "root", "ankit");
						if (conn != null)
						{
				...
				public void actionPerformed(ActionEvent e) {
					try {
						...
						Connection conn = DriverManager.getConnection(
							"jdbc:mysql://localhost:3306/swi", "root", "ankit");
						if (conn != null) 
						{
							stmt = (Statement) conn.createStatement();
							String query3="SELECT * FROM Representative WHERE RepNo IN (SELECT RepNo FROM customer WHERE credit > 15000 )";
